...
! function() {
        ...
        var L = e.frame = function() {
            ...
            P = d(function(e) {
                ...
                e.init = function(t) {
                    ...
                    var n = t.from,
                        i = t.to;
                    void 0 === n && (n = d.from), void 0 === i && (i = d.to), this.unit = t.unit || "", "number" == typeof n && "number" == typeof i ? (this.begin = n, this.change = i - n) : this.format(i, n), this.value = this.begin + this.unit, this.start = D(), !1 !== t.autoplay && this.play()
                }, e.play = function() {
    ...
    var i = {},
        ...
        a = t(function(t) {
            function e(t) {
                d.env() && (w(t.design) && m.on("__wf_design", t.design), w(t.preview) && m.on("__wf_preview", t.preview)), w(t.destroy) && m.on("__wf_destroy", t.destroy), t.ready && w(t.ready) && n(t)
            }
            ...
            var _ = navigator.userAgent.toLowerCase(),
                ...
                z = d.env.touch = "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch,
                O = d.env.chrome = /chrome/.test(_) && /Google/.test(navigator.vendor) && parseInt(T.match(/chrome\/(\d+)\./)[1], 10),
                E = d.env.ios = /(ipod|iphone|ipad)/.test(_);
            d.env.safari = /safari/.test(_) && !O && !E;
            var C;
            z && g.on("touchstart mousedown", function(t) {
                C = t.target
            }), d.validClick = z ? function(t) {
                return t === C || v.contains(t, C)
            } : function() {
                return !0
            };
            var A = "resize.webflow orientationchange.webflow load.webflow";
            d.resize = s(m, A), d.scroll = s(m, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), d.redraw = s(), d.location = function(t) {
                window.location = t
            ...
            d.load = function(t) {
                ...
                t = t || {}, k = !0, m.triggerHandler("__wf_destroy"), null != t.domready && (x = t.domready), b.each(f, r), d.resize.off(), d.scroll.off(), d.redraw.off(), h = [], p = [], "pending" === j.state() && l()
                ...
                return {
                    ready: function() {
                        if (!e.env()) {
                            ...
                            0 !== i.length && i.each(function(e, i) {
                                var r = n(i);
                                r && t(i).prepend(r)
                            })
                        }
    ...
    t(function(t) {
        ...
        e.define("dropdown", t.exports = function(t, i) {
            ...
            function c(t) {
                if (!t.open) {
                    f(t), t.open = !0, t.list.addClass(z), t.toggle.addClass(z), E.intro(0, t.el[0]), e.redraw.up(), t.manageZ && t.el.css("z-index", C + 1);
                    var n = e.env("editor");
        ...
        e.define("ix", t.exports = function(t, i) {
            ...
            function o() {
                var i = t("[data-ix]");
                i.length && (i.each(u), i.each(a), E.length && (e.scroll.on(c), setTimeout(c, 1)), C.length && e.load(l), A.length && setTimeout(d, j), n.init(), e.redraw.up())
            }
                ...
                if (c) {
                    ...
                    l && (g.style(a, c.style), i.each(l, function(t) {
                        ...
                        if ("load" !== u) {
                            ...
                            if ("hover" === u) return a.on("mouseenter" + b, i), a.on("mouseleave" + b, r), void(z = z.add(a));
                            if ("scroll" !== u) {
                                var l = I[u];
                                if (l) {
                                    var d = a.closest(l);
                        ...
                        } else t.preload && !k ? C.push(i) : A.push(i)
                    }))
                }
            }
            ...
            return g.init = function(t) {
                ...
                m = !0, z.each(u), e.scroll.off(c), n.async(), E = [], C = [], A = []
            }, g.ready = function() {
        ...
        function e(t, e, n, i) {
            function r(t, e) {
                return O = _(t) ? t : [t], y || r.build(), O.length > 1 && (y.items = y.empty, O.forEach(function(t) {
                    var e = g("thumbnail"),
                        n = g("item").append(e);
            ...
            r.build = function() {
                ...
                if (t !== b) {
                    ...
                    return b = t, x.show(), c(e.html && w(e.width, e.height) || e.url, function(r) {
                        function o() {
                            x.hide(), t === b ? (m(y.arrowLeft, "inactive", t <= 0), m(y.arrowRight, "inactive", t >= O.length - 1), y.view ? (k(y.view).add("opacity .3s").start({
                                opacity: 0
        ...
        e.define("navbar", t.exports = function(t, i) {
            ...
            function s(e, n) {
                ...
                r || (r = t.data(n, I, {
                    ...
                    el: i,
                    config: {}
                })), r.menu = i.find(".w-nav-menu"), r.links = r.menu.find(".w-nav-link"), r.dropdowns = r.menu.find(".w-dropdown"), r.button = i.find(".w-nav-button"), r.container = i.find(".w-container"), r.outside = m(r), r.el.off(I), r.button.off(I), r.menu.off(I), d(r), T ? (c(r), r.el.on("setting" + I, f(r))) : (l(r), r.button.on("tap" + I, p(r)), r.menu.on("click" + I, "a", v(r))), g(e, n)
            }

            function u(e, n) {
                var i = t.data(n, I);
                i && (c(i), t.removeData(n, I))
            }
            ...
            function m(e) {
                return e.outside && C.off("tap" + I, e.outside), i.debounce(function(n) {
                    if (e.open) {
            ...
            function b(t, n) {
                if (!t.open) {
                    t.open = !0, t.menu.addClass(M), t.links.addClass($), t.button.addClass(q);
                    var i = t.config;
                    ...
                    var r = y(t),
                        ...
                        s = t.el.height(),
                        u = t.el[0];
                    if (g(0, u), L.intro(0, u), e.redraw.up(), T || C.on("tap" + I, t.outside), !n) {
            ...
            function x(t, e) {
                function n() {
                    t.menu.height(""), O(t.menu).set({
                        x: 0,
                        y: 0
                    }), t.menu.removeClass(M), t.links.removeClass($), t.overlay && t.overlay.children().length && (D.length ? t.menu.insertAfter(D) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close")
                }
                if (t.open) {
                    t.open = !1, t.button.removeClass(q);
                    var i = t.config;
                    if (("none" === i.animation || !O.support.transform || i.duration <= 0) && (e = !0), L.outro(0, t.el[0]), C.off("tap" + I, t.outside), e) return O(t.menu).stop(), void n();
            ...
            z.ready = z.design = z.preview = function() {
                T = A && e.env("design"), k = t(document.body), (_ = C.find(I)).length && (_.each(s), r(), o())
            }, z.destroy = function() {
        ...
        e.define("slider", t.exports = function(t, i) {
            function r() {
                (_ = A.find(I)).length && (_.filter(":visible").each(u), O = null, z || (o(), a()))
            }
            ...
            function u(e, n) {
                ...
                if (r || (r = t.data(n, I, {
                        ...
                        el: i,
                        config: {}
                    })), r.mask = i.children(".w-slider-mask"), r.left = i.children(".w-slider-arrow-left"), r.right = i.children(".w-slider-arrow-right"), r.nav = i.children(".w-slider-nav"), r.slides = r.mask.children(".w-slide"), r.slides.each(M.reset), O && (r.maskWidth = 0), !C.support.transform) return r.left.hide(), r.right.hide(), r.nav.hide(), void(z = !0);
                r.el.off(I), r.left.off(I), r.right.off(I), r.nav.off(I), c(r), T ? (r.el.on("setting" + I, m(r)), v(r), r.hasTimer = !1) : (r.el.on("swipe" + I, m(r)), r.left.on("tap" + I, d(r)), r.right.on("tap" + I, f(r)), r.config.autoplay && !r.hasTimer && (r.hasTimer = !0, r.timerCount = 1, p(r))), r.nav.on("tap" + I, "> div", m(r)), j || r.mask.contents().filter(function() {
            ...
            function c(t) {
                ...
                if (e.duration = null != n ? parseInt(n, 10) : 500, l(t.el.attr("data-infinite")) && (e.infinite = !0), l(t.el.attr("data-disable-swipe")) && (e.disableSwipe = !0), l(t.el.attr("data-hide-arrows")) ? e.hideArrows = !0 : t.config.hideArrows && (t.left.show(), t.right.show()), l(t.el.attr("data-autoplay"))) {
                    ...
                    var i = "mousedown" + I + " touchstart" + I;
            ...
            function g(e, n) {
                function i() {
                    f = t(o[e.index].els), p = e.slides.not(f), "slide" !== v && (d.visibility = "hidden"), C(p).set(d)
                }
                n = n || {};
                var r = e.config,
                    o = e.anchors;
                ...
                var c = e.offsetX || 0,
                    ...
                    b = "opacity " + g + "ms " + m,
                    y = "transform " + g + "ms " + m;
                if (T || (f.each(M.intro), p.each(M.outro)), n.immediate && !O) return C(f).set(d), void i();
                if (e.index !== e.previous) {
                    if ("cross" === v) {
                        var x = Math.round(g - g * r.crossOver),
                            k = Math.round(g - x);
                        return b = "opacity " + x + "ms " + m, C(h).set({
                            visibility: ""
                        }).add(b).start({
                            opacity: 0
                        }), void C(f).set({
                    ...
                    return "fade" === v ? (C(h).set({
                        ...
                        x: l
                    }).then(i)) : void(r.infinite && s.x ? (C(e.slides.not(h)).set({
                        visibility: "",
                        x: s.x
                    }).add(y).start({
                        x: l
                        ...
                        x: s.to
                    }), e.shifted = h) : (r.infinite && e.shifted && (C(e.shifted).set({
                        visibility: "",
                        x: c
...
Webflow.require('ix').init([{
    ...
    "slug": "hide-faq-answer",
    "name": "Hide FAQ Answer",
    "value": {
        "style": {
            "display": "none",
            "opacity": 0,
    ...
    "slug": "hide-hero-gradient",
    "name": "Hide Hero Gradient",
    "value": {
        "style": {
            "opacity": 0
        },
        "triggers": [{
            ...
            "stepsA": [{
                ...
                "opacity": 1,
                "transition": "opacity 5000ms ease 0"
            }, {
                "opacity": 0,
                "transition": "opacity 5000ms ease 0"
            }],
    ...
    "slug": "floating-image-2",
    "name": "Floating Image 2",
    "value": {
        "style": {},
        "triggers": [{
            "type": "load",
            ...
            "stepsA": [{
                ...
                "transition": "transform 5000ms ease 0",
                "x": "0px",
                "y": "0px",
                "z": "0px"
            }],
    ...
    "slug": "floating-image-3",
    "name": "Floating Image 3",
    "value": {
        "style": {},
        "triggers": [{
            "type": "load",
